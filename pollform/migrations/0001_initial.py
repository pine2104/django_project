# Generated by Django 3.1.4 on 2021-01-04 07:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('response', models.ManyToManyField(related_name='response', to='pollform.Answer')),
                ('response_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='response_to', to='pollform.form')),
            ],
        ),
        migrations.CreateModel(
            name='Questions',
            fields=[
                ...
                ('choices', models.ManyToManyField(related_name='choices', to='pollform.Choices')),
            ],
        ),
        migrations.AddField(
            model_name='form',
            name='questions',
            field=models.ManyToManyField(related_name='questions', to='pollform.Questions'),
        ),
        migrations.AddField(
            model_name='answer',
            name='answer_to',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answer_to', to='pollform.questions'),
        ),
    ]
